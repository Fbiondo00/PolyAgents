...
bash
\# Nella root del tuo progetto VaultPilot npm  install @hashgraph/sdk hedera-agent-kit dotenv
Aggiungi al tuo .env:
text
...
Nel tuo file principale dell'agente VaultPilot, aggiungi questi tre hook:
typescript
